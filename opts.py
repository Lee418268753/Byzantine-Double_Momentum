...
def get_args(args):
    ...
    parser.add_argument("--datasets", type=str, default="femnist", help="")
    parser.add_argument("--alpha", type=float, default=0.5, help="percentage of non-iid data per worker, value in [0, 1]")
    parser.add_argument("--nnm", action="store_true", default=False, help="nearest neighbor mixing")
    # parser.add_argument("--noniid", type=str,default=False)
    parser.add_argument(
        "--noniid",
        action="store_true",
        default=False,
